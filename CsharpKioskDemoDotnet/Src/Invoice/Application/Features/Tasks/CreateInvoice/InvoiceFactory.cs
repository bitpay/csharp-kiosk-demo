...
public class InvoiceFactory
{
    ...
    )
    {
        var invoice = new Domain.Invoice(
            ...
            createdDate: GetDateTime(bitPayInvoice.InvoiceTime ?? 0),
        ...
        )
        {
            ...
            ExpirationTime = GetDateTime(bitPayInvoice.ExpirationTime ?? 0),
            ...
            LowFeeDetected = Convert.ToBoolean(bitPayInvoice.LowFeeDetected, CultureInfo.InvariantCulture),
